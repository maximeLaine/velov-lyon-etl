...
def extract_json_station_status():
    # Read JSON file station_information
    df = pd.read_json("https://download.data.grandlyon.com/files/rdata/jcd_jcdecaux.jcdvelov/station_status.json")
    ...
    # print(type(data))
    filename = f'station-status-{date_format}.json'
    ...
    bucket_filename = f'station-status/{date_format}.json'
